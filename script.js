...
window.addEventListener("scroll", (event) => {
  ...
  if (scrollFloor < 10 && scrollFloor > 0) {
    $('#bg-img').attr('src', `./Compressed/000${scrollFloor}-min.jpg`)
  } else if (scrollFloor < 100 && scrollFloor > 10){
    $('#bg-img').attr('src', `./Compressed/00${scrollFloor}-min.jpg`)
  }else if (scrollFloor > 100 && scrollFloor < 180){
    $('#bg-img').attr('src', './Compressed/0100-min.jpg')
  } else if (scrollFloor > 180 && scrollFloor < 221) {
    $('#bg-img').attr('src', `./Compressed/0${scrollFloor}-min.jpg`)
  } else if (scrollFloor > 220) {
    $('#bg-img').attr('src', `./Compressed/0220-min.jpg`)
  }
});
